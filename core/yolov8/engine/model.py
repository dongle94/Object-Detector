...
class Model(nn.Module):
    ...
    def _get_hub_session(model: str):
        ...
        from core.yolov8.hub.session import HUBTrainingSession
    ...
    def predict(self, source=None, stream=False, predictor=None, **kwargs):
        ...
        if source is None:
            source = ASSETS
            print(f"WARNING ⚠️ 'source' is missing. Using 'source={source}'.")
    ...
    def track(self, source=None, stream=False, persist=False, **kwargs):
        ...
        if not hasattr(self.predictor, "trackers"):
            from core.yolov8.trackers import register_tracker
    ...
    def benchmark(self, **kwargs):
        ...
        """
        self._check_is_pytorch_model()
        from core.yolov8.utils.benchmarks import benchmark
    ...
    def train(self, trainer=None, **kwargs):
        ...
        if hasattr(self.session, "model") and self.session.model.id:  # Ultralytics HUB session with loaded model
            if any(kwargs):
                print("WARNING ⚠️ using HUB training arguments, ignoring local training arguments.")
    ...
    def tune(self, use_ray=False, iterations=10, *args, **kwargs):
        ...
        self._check_is_pytorch_model()
        if use_ray:
            from core.yolov8.utils.tuner import run_ray_tune
